...
|------|-------------|------|---------|:--------:|
| <a name="input_cloudflare_records"></a> [cloudflare\_records](#input\_cloudflare\_records) | Cloudflare records name, type and value list. | <pre>list(object({<br/>    name     = string,<br/>    type     = string,<br/>    value    = string,<br/>    ttl      = optional(number, 3600)<br/>    priority = optional(number, null)<br/>  }))</pre> | `[]` | no |
